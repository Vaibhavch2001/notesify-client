...
class PastPaperSelector extends StatefulWidget {
  final String branch,sem,subjectName;
  final int SubjectId;
  PastPaperSelector({this.branch,this.sem,this.SubjectId,this.subjectName});
  @override
  _PastPaperSelectorState createState() => _PastPaperSelectorState();
}

class _PastPaperSelectorState extends State<PastPaperSelector> {
        ...
        child: Container(
          child: Column(
            children: [
              ...
              Expanded(
                  child: FutureBuilder(
                    future: _apiClient.getPastPapers(widget.SubjectId),
                    builder: (BuildContext context, AsyncSnapshot<List<PastPaper>> snapshot) {
        ...
        onPressed: (){
          Navigator.push(
            ...
            MaterialPageRoute<void>(
              builder: (BuildContext context) => FullScreenDialog(branch: widget.branch,sem: widget.sem,subjectId: widget.SubjectId,subjectName: widget.subjectName,type: 4,),
